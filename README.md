...
| Sprint | Module Name | Frontend | Backend | Database |
| :--- | :--- | :--- | :--- | :--- |
| 1 | Authentication & JWT | **Login Page:**<br>- [LoginPage.tsx](#)<br>*(User interface for credential entry and secure login)* | **Authentication:**<br>- [Auth Folder](#)<br>*(Controllers for handling login logic and JWT generation)* | **User Schema:**<br>- [User.settings.json](#)<br>*(Extended default schema to include auth-specific fields)* |
| 2 | Account Generation & Management | **Admin Page:**<br>- [AdminDashboard.tsx](#)<br>*(Interface for listing and managing user accounts)*<br><br>**Account Page:**<br>- [AccountProfile.tsx](#)<br>*(Page for updating user profiles and account status)* | **Authorization:**<br>- [Account Folder](#)<br>*(Logic for creating users, updating profiles, and managing status)* | **Audit Schema:**<br>- [AuditLog.settings.json](#)<br>*(Database definition for tracking account activity)* |
| 3 | Role Definition & Permissions | **Permission Hooks:**<br>- [usePermission.ts](#)<br>*(Custom React hook to check user permissions dynamically)*<br><br>**APIs:**<br>- [api/roles.ts](#)<br>*(Frontend API integration files for fetching and updating roles)* | **RBAC Policies:**<br>- [Policies Folder](#)<br>*(Middleware logic to enforce Role-Based Access Control)* | **Role Schema:**<br>- [RolePermissions.settings.json](#)<br>*(Junction table linking Roles to specific Permissions)* |
