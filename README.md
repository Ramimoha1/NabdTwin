...
| Sprint 2|API points created| -                                                             | -  [Api implementation](/backend/be-nabdtwin-strapi/src/api)    | -        |
| Sprint 3|API points Integeration| -[Api Integeration](/frontend/fe-nabdtwinapp/src/services/API) | -       | -        |
