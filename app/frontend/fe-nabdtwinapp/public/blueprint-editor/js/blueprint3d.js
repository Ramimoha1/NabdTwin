    ...
    (function (Items) {
        ...
        var Item = (function (_super) {
            ...
            function Item(model, metadata, geometry, material, position, rotation, scale) {
                ...
                /** */
                this.fixed = false;
                /** Custom properties like employeeId */
...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        var Scene = (function () {
             ...
             * @param customProperties Custom properties like employeeId
             */
            Scene.prototype.addItem = function (itemType, fileName, metadata, position, rotation, scale, fixed, customProperties) {
                itemType = itemType || 1;
                var scope = this;
        ...
        var Model = (function () {
            ...
            Model.prototype.exportSerialized = function () {
                ...
                for (var i = 0; i < objects.length; i++) {
                    ...
                    items_arr[i] = {
                        ...
                        fixed: object.fixed,
                        custom_properties: object.customProperties
                    };
                }
                var room = {
            ...
            Model.prototype.newRoom = function (floorplan, items) {
                ...
                items.forEach(function (item) {
                    ...
                    _this.scene.addItem(item.item_type, item.model_url, metadata, position, item.rotation, scale, item.fixed, item.custom_properties);
                });
            };
            return Model;
        })();
